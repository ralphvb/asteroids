...
const justPressed = {};  // pulsaciones sin consumir
...
// Evita que flechas y espacio hagan scroll de la página
const BLOQUEADAS = ['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'Space'];

window.addEventListener('keydown', e => {
  if (BLOQUEADAS.includes(e.code)) e.preventDefault();
  if (!e.repeat) justPressed[e.code] = true;   // repeat no cuenta como pulsación nueva
  keys[e.code] = true;
});
...
// Al perder el foco se sueltan todas las teclas
